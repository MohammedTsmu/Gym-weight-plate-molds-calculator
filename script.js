...
// .innerHTML = `<p>The thickness of a ${weight}kg weight plate</p><p> with a diameter of ${diameter}cm</p><p> is ${thickness.toFixed(
//     2
// )}cm. </p><p>radius will be ${radius} cm</p><p> Pipe will be ${pipeDiementions} cm </p>`;